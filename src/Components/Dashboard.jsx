...
const DashboardPage= ({ onSectionChange }) => {
  const features = [
    {
      icon: BarChart3,
  ...
  const dashboardSections = [
    {
      title: 'Overview',
      description: 'Get a bird\'s eye view of your preparation progress with key metrics at a glance',
      metrics: ['Total practice hours', 'Interviews completed', 'Current skill level', 'Upcoming sessions']
    },
    {
      title: 'Recent Activity',
      description: 'Quick access to your most recent practice sessions and feedback',
      metrics: ['Last interview date', 'Recent improvements', 'Pending reviews', 'Action items']
    },
    {
      title: 'Skill Assessment',
      description: 'Detailed breakdown of your strengths and areas for improvement across all categories',
      metrics: ['Technical skills', 'Communication', 'Problem solving', 'Behavioral responses']
    },
    {
      title: 'Upcoming Interviews',
      description: 'Keep track of scheduled practice sessions and real interview dates',
      metrics: ['Practice calendar', 'Interview prep checklist', 'Time remaining', 'Readiness score']
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="block text-blue-600">Interview Success</span>
          </h1>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-12 mb-20 border border-blue-100"
        >
          <div className="text-center mb-12">
            <Zap className="h-16 w-16 text-blue-600 mx-auto mb-4" />
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Dashboard Sections</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Your dashboard is organized into intuitive sections for easy navigation
            </p>
          </div>
